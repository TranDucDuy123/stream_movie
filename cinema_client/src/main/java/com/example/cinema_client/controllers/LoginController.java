...
public String login(Model model, HttpServletRequest request, HttpSession session) {
    ...
    try {
        ...
        ResponseEntity<JwtResponseDTO> jwtResponse = restTemplate.exchange(apiLogin, HttpMethod.POST, httpEntity, JwtResponseDTO.class);
        jwt = jwtResponse.getBody();
        session.setAttribute("jwtResponse", jwtResponse.getBody());
